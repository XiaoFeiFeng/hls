            ...
            function ($scope, $ui, $validate, $request, $modalInstance, modalData) {
                ...
                $scope.submitForm = function () {
                    ...
                    if ($scope.data.operator == "edit") {
                        $request.post('shipping/data/?action=edit_logistics_category_channels&_id=' + $scope.data.channel._id.$id,
                            data,
                            function (response) {
                                $ui.notify('保存成功！', '提示',
                                    function () {
                        ...
                        $request.post('shipping/data/?action=add_logistics_category_channels',
                            data,
                            function (response) {
