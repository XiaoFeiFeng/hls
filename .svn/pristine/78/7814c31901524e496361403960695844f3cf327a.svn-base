...
define(['angular', 'angularAMD', 'uiRouter', 'blockUI', 'bootstrap', 'ui-bootstrap', 'angular-sanitize',
    'hls-util',
    ...
    app.controller('indexCtrl', ['$scope', '$timeout', '$ui', function ($scope, $timeout, $ui) {
        ...
        function openWindwo(point) {
            ...
            var sContent =
                ...
                "<img style='float:right;margin:4px' id='imgDemo' src='../img/el_logo.jpg' width='139' height='104' title='易联速递'/>" +
        ...
        function addCustomMarker() {
            ...
            var myIcon = new BMap.Icon("../img/icon/favicon.png", new BMap.Size(32, 32));
